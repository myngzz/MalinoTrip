...
<body>
    ...
    <div class="container" id="tilt-container">
        <form method="post">
            ...
            <p class="tagline">Bergabung Sekarang dan Jadilah Bagian dari Kami!</p>
            <table align="center">
                <tr>
                    <td>Nama</td>
                    <td class="input-group">
                        <input type="text" name="nama" id="nama" placeholder=" " required aria-label="Nama">
                ...
                <tr>
                    <td></td>
                    <td>
                        <button type="submit" onclick="playClickSound()">Daftar User</button>
                        <a href="login.php" onclick="playClickSound()">Login</a>
                    </td>
                </tr>
            </table>
        </form>
